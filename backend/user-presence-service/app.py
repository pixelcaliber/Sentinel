...
DATABASE_URL = "postgresql://postgres:12345@localhost:5433/chat-app-user-db"
...
def mark_inactive_users():
    while True:
        ...
        for key in user_keys:
            ...
            logging.info(f"user_id is : {user_id}")
            if time_difference > 100:
                ...
                try:
                    ...
                    logging.info(f"Error marking user {user_id} as inactive:", e)
                finally:
                    new_session.close()
        time.sleep(60)
...
def update_last_active():
    ...
    try:
        ...
        user.active = True
        new_session.commit()
        logging.info(f"Last active time updated successfully for {user_id}.")
